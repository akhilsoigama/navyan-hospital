...
export interface Registry {
  ...
  'users.users.update_profile': {
    ...
    types: {
      ...
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/users_controller').default['updateProfile']>>>
    }
  }
  'users.users.change_password': {
    ...
    types: {
      ...
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/users_controller').default['changePassword']>>>
    }
  }
  'users.users.set_active': {
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/users_controller').default['setActive']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/users_controller').default['setActive']>>>
    }
  }
  'users.users.destroy': {
    methods: ["DELETE"]
